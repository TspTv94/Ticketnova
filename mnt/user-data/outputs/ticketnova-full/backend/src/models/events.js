/**
 * TicketNova — Events Data Model
 * File: backend/src/models/events.js
 *
 * Acts as the in-memory database for events.
 * In production: swap this with a Mongoose model connected to MongoDB.
 */
